    ...
    <>
      ...
      <section id="kontak" className="cta-section" ref={sectionRef}>
        ...
        <div className="cta-bg" aria-hidden="true">
          <svg width="100%" height="100%" viewBox="0 0 1220 810" fill="none"
            xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
            <g clipPath="url(#cta-clip)">
              <mask id="cta-mask" style={{ maskType: "alpha" as const }}
                maskUnits="userSpaceOnUse" x="10" y="-1" width="1200" height="812">
                <rect x="10" y="-0.84668" width="1200" height="811.693"
              ...
              <g mask="url(#cta-mask)">
                {[...Array(35)].map((_, i) =>
                  [...Array(23)].map((_, j) => (
                    <rect key={`${i}-${j}`}
                      x={-20.09 + i * 36} y={9.2 + j * 36}
                      width="35.6" height="35.6"
              ...
              {/* Mouse glow */}
              <circle cx={mousePos.x} cy={mousePos.y} r="140"
                fill="url(#cta-mouse-glow)" opacity="0.12"
                style={{ pointerEvents: "none", transition: "cx 50ms, cy 50ms" }}
              />

              {/* Indigo glow shape kanan */}
              <g filter="url(#cta-blur1)">
                <path d="M1447 -87V-149H1770V1249H466V894C1008 894 1447 455 1447 -87Z"
                  fill="url(#cta-grad1)" opacity="0.4" />
              </g>
              <g filter="url(#cta-blur2)">
                <path d="M1383 -151V-213H1706V1185H402V830C944 830 1383 391 1383 -151Z"
                  fill="url(#cta-grad2)" fillOpacity="0.25" />
              </g>
              ...
              <defs>
                ...
                <filter id="cta-blur1" x="147" y="-468" width="1942" height="2036"
                  filterUnits="userSpaceOnUse">
                  <feGaussianBlur stdDeviation="159" />
                </filter>
                <filter id="cta-blur2" x="-554" y="-1170" width="3217" height="3311"
                  filterUnits="userSpaceOnUse">
                  <feGaussianBlur stdDeviation="478" />
                </filter>
                <linearGradient id="cta-grad-mask" x1="35" y1="23" x2="904" y2="632"
                  gradientUnits="userSpaceOnUse">
                  <stop stopColor="white" stopOpacity="0" />
                  <stop offset="1" stopColor="white" />
                </linearGradient>
                <linearGradient id="cta-grad1" x1="1118" y1="-149" x2="1118" y2="1249"
                  gradientUnits="userSpaceOnUse">
                  <stop stopColor="#6366F1" />
                  <stop offset="0.58" stopColor="#3730A3" stopOpacity="0.8" />
                  <stop offset="1" stopColor="#1E1B4B" />
                </linearGradient>
                <linearGradient id="cta-grad2" x1="1054" y1="-213" x2="1054" y2="1185"
                  gradientUnits="userSpaceOnUse">
        ...
        <div className="cta-content">
          ...
          <p className="cta-sub">
            Ceritakan kebutuhan bisnis Anda. Kami dengarkan, analisis,<br />
            dan berikan solusi terbaik - tanpa tekanan, tanpa komitmen.
          </p>

          <div className="cta-actions">
            <a
              href="https://wa.me/6281234567890?text=Halo%20KarsaHub%2C%20saya%20ingin%20konsultasi%20gratis"
              className="btn btn-accent btn-lg"
              target="_blank"
              rel="noopener"
            >
              <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" style={{ marginRight: 6 }}>
            ...
            <a href="mailto:hello@karsahub.id"
